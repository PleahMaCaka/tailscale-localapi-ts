...
export interface NodeOps {
   ...
   *
   * @remarks
   * Risk: **breaking**. Irreversible. The machine loses its addresses and has
...
export interface KeyOps {
   ...
   * Revokes a key.
   *
   * Takes the whole key because the two control planes identify keys differently:
...
export interface PolicyOps {
   ...
   * the meantime. Control planes without a concurrency token ignore it.
   *
   * @remarks
   * Risk: **breaking**. This is the whole tailnet's firewall in one call. Both
