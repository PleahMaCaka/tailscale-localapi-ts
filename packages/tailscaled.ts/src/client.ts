...
export class Tailscaled {
   ...
   *
   * @remarks
   * Risk: **danger**. The node key is dropped and the backend lands in
   ...
   *
   * @remarks
   * Risk: **danger**. Harsher than {@link Tailscaled.logout}: re-authentication
   ...
   *
   * @remarks
   * Risk: **danger**. Nothing in this library can start it again; whatever
